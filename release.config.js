...
module.exports = {
  debug: true,
  repositoryUrl: 'https://gitlab.com/palqee/web-ui.git',
  ...
  plugins: [
    ...
    [
      'semantic-release-slack-bot',
      {
        ...
        notifyOnFail: false,
        slackWebhook:
          'https://hooks.slack.com/services/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',
        branchesConfig: [
          {
            pattern: 'master',
        ...
        // https://github.com/juliuscc/semantic-release-slack-bot/issues/59
        packageName: require('./apps/dashboard/package.json').name,
      },
    ],
    ...
    [
      ...
      {
        gitlabUrl: 'https://gitlab.com/palqee/web-ui.git',
      },
    ],
